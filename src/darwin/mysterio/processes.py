...
kernel, causal_learner, simulator, private_simulator, planner, self_modeler,
...
DEFAULT_ROSTER: list[SubsystemSpec] = [
    ...
    SubsystemSpec("private_simulator", "darwin.mysterio.processes:_heartbeat",
                  priority=70, topics=["private_simulations"]),
