...
def test_default_suite_has_tasks_in_every_category() -> None:
    ...
    # The default suite covers the legacy seven categories; "capability"
    # is populated by build_capability_suite() instead.
    legacy = set(CATEGORIES) - {"capability"}
...
def test_default_suite_has_at_least_one_task_per_category() -> None:
    ...
    for category in CATEGORIES:
        if category == "capability":
            # The capability category is populated by build_capability_suite()
